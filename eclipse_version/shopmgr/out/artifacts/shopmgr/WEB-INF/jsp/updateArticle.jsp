...
<div class="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        <fieldset style="width:700px;"><legend>修改物品</legend>
            ...
            <form id="articleform" name="articleform" class="form-horizontal" action="${pageContext.request.contextPath}/list?method=updateArticle"
                  method="post" enctype="multipart/form-data">
                <!-- 隐藏表单用来传输要修改的物品编号 -->
                <input type="hidden" id="id" name="id" value="${article.id}"/>
                <!-- 保留商品当前的图片地址：如果不修改图片依然会使用这个图片地址 -->
                <input type="hidden" id="picUrl" name="picUrl" value="${article.image}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type=text value="${article.title}" class="form-control" id="titleStr" name="titleStr" size="50">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type=text value="${article.supplier}" class="form-control" id="supplier" name="supplier" size="50">
                    </div>
                    <label class="col-sm-3 control-label">地区：</label>
                    <div class="col-sm-3">
                        <input type=text class="form-control" value="${article.locality}" id="locality" name="locality" size="50">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type=text class="form-control" value="${article.price}" id="price" name="price" size="50">
                    </div>
                    <label class="col-sm-3 control-label">库存数量：</label>
                    <div class="col-sm-3">
                        <input type=text class="form-control" value="${article.storage}" id="storage" name="storage" size="50">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="file" class="form-control"  id="image" name="image" size="40" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea rows="5" cols="60"  class="form-control" id="description" name="description">${article.description}</textarea>
                    </div>
                </div>
                <table align="center">
                    <tr>
